...
| Border | `--border` | `#52525c` | Dividers, card borders |
...
- **accents-7:** `#333333`
- **geist-violet-background-secondary:** `#291c3a` — Secondary text, placeholder text
...
Scale: `.125rem, .25rem, .375rem, .5rem, .75rem, 1rem, 1px, 1.5cqw, 2px, 2.5px, 3px, 4px, 5px, 6px, 8px, 9px, 10px, 12px, 14px, 15cqw, 16px, 20px, 24px, 26px, 32px, 40px, 44px, 48px, 52px, 99px, 100%, inherit, 64px, 128px, 218.427px, 999px`
Default: `14px`
...
- **Duration scale:** `0s`, `0ms`, `.1s`, `.15s`, `.16s`, `.18s`, `.2s`, `.225s`, `.25s`, `.3s`, `.35s`, `.4s`, `.5s`, `.6s`, `.7s`, `.75s`, `.8s`, `.95s`, `1s`, `1.2s`, `2s`, `90ms`, `100ms`, `125ms`, `130ms`, `150ms`, `200ms`, `250ms`, `300ms`, `400ms`, `500ms`, `700ms`, `1000ms`
- **Easing functions:** `cubic-bezier(.6,.3,.98,.5)`, `cubic-bezier(.1,0,.1,1.1)`, `cubic-bezier(.5,0,.1,1.2)`, `cubic-bezier(.23,1,.32,1)`, `cubic-bezier(.25,1,.5,1)`, `cubic-bezier(.32,.72,0,1)`, `cubic-bezier(.455,.03,.515,.955)`, `cubic-bezier(0,0,.2,1)`, `cubic-bezier(.3,.57,.07,.95)`, `cubic-bezier(.25,.57,.45,.94)`, `cubic-bezier(.25,.75,.6,.98)`, `cubic-bezier(.29,.31,.05,.96)`, `ease`, `linear`, `cubic-bezier(.2,-.5,0,1.5)`, `cubic-bezier(.4,.04,.04,1)`, `cubic-bezier(.77,0,.175,1)`, `ease-out`, `cubic-bezier(.4,0,.2,1),cubic-bezier(.4,0,.2,1)`, `cubic-bezier(.8,0,1,1)`, `cubic-bezier(.645,.045,.355,1)`, `ease-in-out`, `cubic-bezier(.33,.01,.63,1.01)`, `cubic-bezier(.31,.05,.43,1.02)`, `cubic-bezier(.39,.18,.17,.99)`, `cubic-bezier(.14,.55,.3,.92)`, `cubic-bezier(.5,.25,.35,1)`
...
- Subtle: `inset 2px 0 0 0 var(--ds-amber-900)`
- Subtle: `inset 2px 0 0 0 var(--ds-green-900)`
